...
<html lang="en">
  ...
  <body>
    ...
    <div class="container text-center my-5">
      ...
      <a href="controller?command=filterOrdersByUser" class="btn btn-primary btn-lg">Find orders by user</a>
    </div>
      ...
      <tbody>
        <c:forEach items="${orders}" var="order" varStatus="counter">
          <tr>
            ...
            <td>${order.status}</td>
            <td>
              <a class="btn btn-primary btn-sm" href="controller?command=order&id=${order.id}">Details</button>
            </td>
          </tr>
        </c:forEach>
      </tbody>
